    ...
    <div class="nes-container with-title">
      ...
      <div id="game-menu">
        ...
        <div class="link-badges">
          <div>
            <a class="nes-icon github is-large" href="https://github.com/abbaskhurram255/vue-jsnake" target="blank"></a>
          </div>

          <div>
            <a class="nes-icon twitter is-large" href="https://twitter.com/alexputh255" target="blank"></a>
          </div>
        </div>
      </div>
    </div>
